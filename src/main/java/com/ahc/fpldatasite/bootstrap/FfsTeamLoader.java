...
public class FfsTeamLoader {
    ...
    protected void getFantasyData() throws IOException {
        ...
        for (Element element : table.select(expr)) {
            ...
            fantasy.setGamesPlayed(Integer.valueOf(tableData.next().text()));
            fantasy.setGoals(Integer.valueOf(tableData.next().text()));
            ...
            fantasy.setCleanSheets(Integer.valueOf(tableData.next().text()));
            fantasy.setGoalsConceded(Integer.valueOf(tableData.next().text()));
